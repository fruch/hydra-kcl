...
public class StreamsAdapterDemo {
    ...
    private static String tablePrefix = "usertable";
    ...
    public static void main(String[] args) throws Exception {
        ...
        endpoint = new AwsClientBuilder.EndpointConfiguration("http://localhost:8080", "us-east-1");

        dynamoDBClient = AmazonDynamoDBClientBuilder.standard()
                                                    .withEndpointConfiguration(endpoint)
                                                    .build();
        cloudWatchClient = new DummyCloudWatchClient();
